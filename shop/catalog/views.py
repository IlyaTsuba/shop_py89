...
class BasketView(APIView):
    ...
    @swagger_auto_schema(request_method='GET', responses={200: BasketSerializer}, tags=['catalog'])
    ...
    @swagger_auto_schema(request_method="POST", request_body=AddProductSerializer, responses={200: ''}, tags=['catalog'])

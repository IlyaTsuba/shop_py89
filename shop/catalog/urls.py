...
from catalog.views import CategoryListView, CategoryProductsView, DiscountsListView, DiscountProductsView, \
    SellersListView, SellerProductsView, BasketView, OrderView

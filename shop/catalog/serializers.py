...
class ProductSerializer(ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ('id', 'name', 'price', 'articul', 'description', 'count_on_stock', 'discount', 'category', 'seller')
...
class OrderSerializer(ModelSerializer):
    ...
    class Meta:
        model = Order
        fields = ('created_at', 'promocode', 'delivery_time', 'delivery_notif_in_time', 'delivery_time',
                  'delivery_method', 'delivery_status', 'payment_method', 'payment_status',
